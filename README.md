...
Dit document bevat een toelichting op de VUM Koppelvlak specificaties. De VUM Koppelvlak specificaties zijn vastgelegd in zes OpenAPI 3.0.0 documenten. Elk van deze documenten beschrijft twee koppelvlakken.
...
*  VUM-Bemiddelaar-Werkgeverscontactmomenten:
	*  Koppelvlak met de VUM Uitwisselingsvoorziening voor selecteren van werkgeverscontactmomenten
	*  Koppelvlak met de VUM Uitwisselingsvoorziening voor het opvragen van een detail weergave van een werkgeverscontactmoment
* VUM-Bron-Werkgeverscontactmomenten:
	* Koppelvlak met een VUM bron voor het selecteren van werkgeverscontactmomenten
	* Koppelvlak met een VUM bron voor het opvragen van een detail weergave van een werkgeverscontactmoment
